...
import { Briefcase, Building2, IndianRupee, Info, Target, TrendingUp, Users } from "lucide-react";
      ...
      actions={
        <>
          ...
          <Button size="sm" className="gap-2">
            <Info className="h-3.5 w-3.5" /> AI Talent Match
          </Button>
        </>
      }
    >
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 xl:grid-cols-5">
          ...
          <Kpi label="Offers released" value={24} delta="+8" icon={Info} accent="success" />
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          ...
          <Section title="Recruitment ROI" description="vs industry benchmark" unique>
            <div className="grid grid-cols-2 gap-4">
              ...
              <Kpi label="Hiring success" value="92%" delta="+8%" icon={Info} accent="success" />
            </div>
          </Section>
        </div>
