      ...
      actions={
        <>
          ...
          <Button size="sm" className="gap-2">
            <Sparkles className="h-3.5 w-3.5" /> Career counselling
          </Button>
        </>
      }
    >
              ...
              <div className="flex flex-col gap-6 p-6 md:flex-row md:items-center md:justify-between">
                <div className="min-w-0">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <span className="pill pill-primary"><Sparkles className="h-3 w-3" /> 6 mocks completed</span>
            ...
            <Section title="This week's priority" description="AI-curated, in order of impact">
              <ul className="space-y-3">
                {[
                  ...
                  { t: "Complete System Design basics (12h)", reason: "Closes top rejection cause", icon: Sparkles },
                ].map((t, i) => (
