...
import { Briefcase, Building2, ChevronRight, Filter, Sparkles, Target, Users, Video } from "lucide-react";
    ...
    <AppShell
      ...
      actions={
        <>
          ...
          <Button size="sm" className="gap-2"><Sparkles className="h-3.5 w-3.5" /> AI student–JD matcher</Button>
        </>
      }
    >
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 xl:grid-cols-7">
          ...
          <Kpi label="Offers generated" value={612} delta="+74 MoM" icon={Sparkles} accent="success" />
